...
add_bullet(doc, "Toàn bộ các số liệu khảo sát, kiến trúc giải pháp, lược đồ thiết kế CSDL, các dòng mã nguồn chương trình (ai_engine.js, auto_cron.js, front-page.js, single.js) và kết quả kiểm thử Google Lighthouse được trình bày trong báo cáo đều được thực hiện trên hệ thống thật và không sao chép trái phép từ bất kỳ tài liệu hay công trình nào khác.", "2. ")
...
# ============================================================
add_heading_1(doc, "DANH MỤC HÌNH ẢNH & SƠ ĐỒ MINH HỌA")
figs_master = [
    ...
    ("Hình 4.3: Giao diện Trang chủ Next.js Dark Mode thực tế (localhost:3000)", "24"),
    ("Hình 4.4: Giao diện Trang đọc chi tiết bài viết (single.js) với Typography cao cấp", "25"),
    ("Hình 5.1: Khung mã nguồn giải quyết xung đột SCSS Breakpoints (_blocks.scss)", "27"),
    ("Hình 5.2: Kết quả kiểm thử Google Lighthouse đạt điểm tuyệt đối 100/100 Xanh", "29"),
    ("Hình 6.1: Infographic mô phỏng Định luật Tăng trưởng GAS (G = A² × S)", "31"),
    ("Hình 6.2: Mô hình Trạm nạp nhiên liệu số GAS Fueling Station cho doanh nghiệp", "33"),
    ("Hình 6.3: Cấu trúc tệp chuẩn hóa llms.txt phục vụ Generative Engine Optimization", "35"),
    ("Hình 7.1: Sơ đồ Gantt Chart tiến độ thực hiện đồ án 16 tuần", "37"),
]
...
add_heading_2(doc, "4.3. Ảnh chụp giao diện thực tế hệ thống")
add_paragraph(doc, "Dưới đây là hình ảnh thực tế của hệ thống sau khi khởi chạy hoàn tất trên môi trường phát triển:")

add_figure(doc, "fig_4_3_ui_homepage.png", "Hình 4.3: Giao diện Trang chủ Next.js Dark Mode thực tế (localhost:3000)")

add_figure(doc, "fig_4_4_ui_single_post.png", "Hình 4.4: Giao diện Trang đọc chi tiết bài viết (single.js) với Typography cao cấp")
...
add_heading_2(doc, "6.1. Định luật Tăng trưởng Độc quyền GAS (G = A² × S)")
add_paragraph(doc, "Trên hệ sinh thái thương mại (`Agency_Landing_Page`), chúng tôi đã phát triển Định luật Tăng trưởng Độc quyền GAS mô phỏng theo phương trình vật lý nổi tiếng $E = mc^2$:")

add_figure(doc, "fig_6_2_gas_formula.png", "Hình 6.1: Infographic mô phỏng Định luật Tăng trưởng GAS (G = A² × S)")

add_heading_2(doc, "6.2. Hình tượng Trạm Nạp Nhiên Liệu Số (GAS Fueling Station)")
add_paragraph(doc, "Hình tượng Trạm sạc nhiên liệu số giúp doanh nghiệp hình dung sinh động về việc nạp năng lượng nội dung tự động cho website:")
...
add_paragraph(doc, "Hệ thống hỗ trợ tệp chuẩn hóa `public/llms.txt` giúp các mô hình AI thế hệ mới (ChatGPT, Perplexity, Gemini) trích xuất dữ liệu công ty trong 0.05 giây và tiến cử thương hiệu ở vị trí số 1:")

add_figure(doc, "fig_6_5_llms_txt.png", "Hình 6.3: Cấu trúc tệp chuẩn hóa llms.txt phục vụ Generative Engine Optimization")

add_heading_2(doc, "6.4. Bài toán chứng minh ROI: Đầu tư 7 triệu thu về 120 triệu")
add_paragraph(doc, "Phương trình Lợi tức Đầu tư (ROI) giúp thuyết phục tuyệt đối các chủ doanh nghiệp:")
add_paragraph(doc, "• Doanh thu mới từ SEO tự nhiên: Xuất bản 30 bài/tháng -> Sau 6 tháng có 180 bài -> Thu hút 5.400 lượt truy cập tự nhiên/tháng -> 81 khách hàng tiềm năng (Leads) -> Chốt 8 hợp đồng mới/tháng x 15.000.000đ = 120.000.000đ doanh thu mới mỗi tháng. Tỷ suất sinh lời ROI đạt 1.614%.")
add_paragraph(doc, "• Tiết kiệm trực tiếp tiền quảng cáo: Mua 5.000 clicks Google Ads tốn 75 triệu/tháng. Gói AI của chúng tôi chỉ 7 triệu/tháng -> Tiết kiệm ngay 68 triệu tiền mặt mỗi tháng.")
add_paragraph(doc, "• Cắt giảm quỹ lương nhân sự: Thuê 1 nhân viên Content in-house tốn 14-15 triệu/tháng. Dùng dịch vụ AI 7 triệu/tháng -> Tiết kiệm ngay 7-8 triệu/tháng vào lợi nhuận ròng của công ty.")
...
print("MASTER THESIS CREATED: " + output_master)
